      ...
      warehouses.map((wh, i) => (
        ...
        >
          ...
          <div className="flex justify-between items-start">
            ...
            {/* Assigned */}
            {wh.staff_name ? (
              <span className="px-2 py-1 rounded-full text-xs font-medium text-white bg-green-600 text-center">
                {wh.staff_name}
              </span>
            ) : (
      ...
      <tbody>
        {warehouses.map((wh, i) => (
          <tr key={wh.id} className="border-t hover:bg-neutralLight">
            ...
            <td className="p-3 text-sm">{wh.address}</td>
            ...
            <td className="p-3 text-sm">
              <div className="flex justify-center gap-2">
                <button onClick={() => handleRecords(wh)}>
                  <FaFileAlt size={16} />
                </button>
