...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    const fetchOverview = async () => {
      try {
        const res = await axios.get(`${API_URL}/overview/${user.id}`, {
          headers: {
    ...
    <>
      ...
      >
        ...
        <p className="text-neutralDark">
          Here you can manage users, inventory, and monitor warehouse
          operations.
        </p>
      </motion.div>
      ...
      >
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center h-72">
            ...
            />
            <h2 className="text-2xl font-bold text-primary">Loading Overview...</h2>
          </div>
        ) : (
